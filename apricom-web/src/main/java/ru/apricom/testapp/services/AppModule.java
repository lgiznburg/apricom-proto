...
import ru.apricom.testapp.encoders.CountryValueEncoder;
...
/*
    public static void contributeValueEncoderSource( MappedConfiguration<Class,
        ...
        configuration.add( BaseCatalog.class, new CatalogValueEncoder() );
        configuration.add( Country.class, new CountryValueEncoder() );
    }
*/
}